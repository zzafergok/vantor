  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        'vantor-blue': {
          50: 'hsl(var(--vantor-blue-50))',
          100: 'hsl(var(--vantor-blue-100))',
          200: 'hsl(var(--vantor-blue-200))',
          300: 'hsl(var(--vantor-blue-300))',
          400: 'hsl(var(--vantor-blue-400))',
          500: 'hsl(var(--vantor-blue-500))',
          600: 'hsl(var(--vantor-blue-600))',
          700: 'hsl(var(--vantor-blue-700))',
          800: 'hsl(var(--vantor-blue-800))',
          900: 'hsl(var(--vantor-blue-900))',
          950: 'hsl(var(--vantor-blue-950))',
          DEFAULT: 'hsl(var(--vantor-blue))',
        },
        'signal-green': {
